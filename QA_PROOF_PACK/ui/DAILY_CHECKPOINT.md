...
| **P5 Marketplace** | **PASS · payment leg autonomously proven on chain** | (1) NEW input UI verified rendering live · (2) auto-MM harness drove BOTH SIWE + paySkillRun popups end-to-end with zero operator clicks · (3) **real on-chain payment tx `0x0e07ebad756e0ddd5886d683b42f32328006a610381ae0698341b25c5ec74649` settled on Galileo** with proper 90/10 split · (4) honest PIPELINE_FAILED_POST_PAYMENT UX shows tx hash + refund instructions · all 5 routes HTTP 200 | Inference step post-payment hits same 0G Router/Compute infra timeout as P3 (Vercel maxDuration). Receipt anchoring proved via separate operator-side runs. Refund queue is the documented backstop |
