// v3-lookup-allow: debug reader inspects V1+V2 chain state for diagnostic depth — intentional. V3 receipts are visible via `ivaronix receipt show <id>` (V2-first lookup includes V3) and `ivaronix debug skill` (iter-22 V2/V3 read). The §B-V2-37 reader migration is shipped (✅ shipped) across serve.ts, mcp-server, and indexer; this debug surface stays V1+V2 for legacy depth.
