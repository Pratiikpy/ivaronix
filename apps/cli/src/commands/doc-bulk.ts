// v3-lookup-allow: bulk writer emits slots 0-9 only (doc_ask/consensus/burn/skill_exec). Reader-side fix shipped for §B-V2-37 (✅ shipped); writer stays grandfathered until/unless a slot 10+ extension lands here.
