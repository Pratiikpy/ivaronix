...
| 5 | Receipt anchoring | ✓ | <!-- numbers:auto:receipts.total -->1663<!-- /numbers:auto:receipts.total -->+ receipts on `ReceiptRegistry` (V1) + `ReceiptRegistryV2` + `ReceiptRegistryV3` (B-V2-32 · canonical slots 10/11/12) |
...
ivaronix debug chain
  receipts anchored    <!-- numbers:auto:receipts.total -->1663<!-- /numbers:auto:receipts.total -->  (ReceiptRegistry V1 + V2 .nextId() · live)
```
