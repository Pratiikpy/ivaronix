...
| 5 | Receipt anchoring | ✓ | <!-- numbers:auto:receipts.total -->1652<!-- /numbers:auto:receipts.total -->+ receipts on `ReceiptRegistry.nextId()` (V1) + `ReceiptRegistryV2.nextId()` |
...
ivaronix debug chain
  receipts anchored    <!-- numbers:auto:receipts.total -->1652<!-- /numbers:auto:receipts.total -->  (ReceiptRegistry V1 + V2 .nextId() · live)
```
