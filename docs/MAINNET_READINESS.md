...
> <!-- numbers:auto:mainnet.receiptsAnchored -->72<!-- /numbers:auto:mainnet.receiptsAnchored --> receipts anchored on `ReceiptRegistryV3` across all
...
<!-- numbers:auto:mainnet.receiptsAnchored -->72<!-- /numbers:auto:mainnet.receiptsAnchored --> receipts have been anchored on it spanning all <!-- numbers:auto:receiptTypes.count -->13<!-- /numbers:auto:receiptTypes.count -->
