...
| 18 | **pc.0g.ai adapter** in `og-router` | 🔴 NOT STARTED | cron | typechecks + unit test; live test waits for mainnet |
| 19-22 | **Content gaps** — before/after (3 anonymized contracts) · manifesto · why-now · `/faq` page | 🔴 NOT STARTED | cron | footer manifesto link · `/faq` route · before/after on home |
...
| 31 | **`docs/UI_HALF_BAKED_AUDIT.md`** — 6-state classification per visible feature | 🔴 NOT STARTED | cron | doc fresh within 7 days |
