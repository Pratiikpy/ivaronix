...
|---|---|
| **<!-- numbers:auto:receipts.total -->1657<!-- /numbers:auto:receipts.total -->+ receipts** anchored on chain | [`ReceiptRegistry`](https://chainscan-galileo.0g.ai/address/0x97376C6f0BE0Ee08AA34C4cAcdbDeC2183e7743c) (V1) + [`ReceiptRegistryV2`](https://chainscan-galileo.0g.ai/address/0xf675d4183b34fe8d1981FA9c117065aAcff690ab) (V2) + [`ReceiptRegistryV3`](https://chainscan-galileo.0g.ai/address/0x7396D536594e2BE833070c7EB441A10906046257) (V3 · canonical slots 10/11/12 admitted post-B-V2-32) |
| **<!-- numbers:auto:contracts.deployed -->13<!-- /numbers:auto:contracts.deployed --> contracts** deployed on Galileo | `ReceiptRegistry` V1 + V2 + V3 · `AgentPassportINFT` V1 + V2 · `CapabilityRegistry` V1 + V2 · `MemoryAccessLog` V1 + V2 · `SkillRegistry` V1 + V2 · `SubscriptionEscrowV2` · `Erc7857Verifier` — full table with chainscan links in [`docs/MAINNET_READINESS.md`](./MAINNET_READINESS.md) (auto-rendered from `contracts/deployments/testnet.json`). |
