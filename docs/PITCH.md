...
|---|---|
| **<!-- numbers:auto:receipts.total -->1664<!-- /numbers:auto:receipts.total -->+ receipts** anchored on chain | [`ReceiptRegistry`](https://chainscan-galileo.0g.ai/address/0x97376C6f0BE0Ee08AA34C4cAcdbDeC2183e7743c) (V1) + [`ReceiptRegistryV2`](https://chainscan-galileo.0g.ai/address/0xf675d4183b34fe8d1981FA9c117065aAcff690ab) (V2) + [`ReceiptRegistryV3`](https://chainscan-galileo.0g.ai/address/0x7396D536594e2BE833070c7EB441A10906046257) (V3 · canonical slots 10/11/12 admitted post-B-V2-32) |
...
**Year 1 — testnet → mainnet → first 10 firms.** Phase A (Galileo testnet) is complete; <!-- numbers:auto:receipts.total -->1664<!-- /numbers:auto:receipts.total -->+ receipts anchored, 13/13 mainnet-readiness items GREEN, the deploy script is identical for chainId 16661. Phase B is the funded mainnet promotion plus the Confidential Data Room as the headline product. Target: ten paying law firms, two M&A advisory boutiques, one Big-Four-adjacent due-diligence team. Pricing: per-room or per-GB-month, undercut Datasite by 30 %, win on independent verifiability.
