...
|---|---|
| **<!-- numbers:auto:receipts.total -->1731<!-- /numbers:auto:receipts.total -->+ receipts** anchored on chain | [`ReceiptRegistry`](https://chainscan-galileo.0g.ai/address/0x97376C6f0BE0Ee08AA34C4cAcdbDeC2183e7743c) (V1) + [`ReceiptRegistryV2`](https://chainscan-galileo.0g.ai/address/0xf675d4183b34fe8d1981FA9c117065aAcff690ab) (V2) + [`ReceiptRegistryV3`](https://chainscan-galileo.0g.ai/address/0x7396D536594e2BE833070c7EB441A10906046257) (V3 · canonical slots 10/11/12 admitted post-B-V2-32) |
| **<!-- numbers:auto:contracts.deployed -->15<!-- /numbers:auto:contracts.deployed --> contracts** deployed on Galileo | `ReceiptRegistry` V1 + V2 + V3 · `AgentPassportINFT` V1 + V2 · `CapabilityRegistry` V1 + V2 · `MemoryAccessLog` V1 + V2 · `SkillRegistry` V1 + V2 · `SubscriptionEscrowV2` · `Erc7857Verifier` — full table with chainscan links in [`docs/MAINNET_READINESS.md`](./MAINNET_READINESS.md) (auto-rendered from `contracts/deployments/testnet.json`). |
| **<!-- numbers:auto:skills.firstParty -->10<!-- /numbers:auto:skills.firstParty --> first-party skills** with on-chain receipts | private-doc-review · github-audit · 0g-integration-auditor · plan-step · code-edit · content-pitch-review |
| **<!-- numbers:auto:skills.catalogTotal -->160<!-- /numbers:auto:skills.catalogTotal --> skills** in the catalog (`/v1/skills`) | first-party + <!-- numbers:auto:skills.vendored -->150<!-- /numbers:auto:skills.vendored --> vendored |
| **<!-- numbers:auto:contracts.foundryTests -->227<!-- /numbers:auto:contracts.foundryTests -->/<!-- numbers:auto:contracts.foundryTests -->227<!-- /numbers:auto:contracts.foundryTests --> Foundry tests passing** | Forge suite green |
...
**Year 1 — testnet → mainnet → first 10 firms.** Phase A (Galileo testnet) is complete; <!-- numbers:auto:receipts.total -->1731<!-- /numbers:auto:receipts.total -->+ receipts anchored, 13/13 mainnet-readiness items GREEN, the deploy script is identical for chainId 16661. Phase B is the funded mainnet promotion plus the Confidential Data Room as the headline product. Target: ten paying law firms, two M&A advisory boutiques, one Big-Four-adjacent due-diligence team. Pricing: per-room or per-GB-month, undercut Datasite by 30 %, win on independent verifiability.
